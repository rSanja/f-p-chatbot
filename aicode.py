...
if "messages_history" not in st.session_state:
    ...
    st.session_state["messages_history"] = [
        SystemMessage(
            "You are a website programmer using the Laravel framework, I master HTML, Java Script, Python, and CSS. Always response in less than 3 sentences in a chat style. Reply in bahasa indonesia"
        )
    ]

st.text("Dengan AI man Code, ada yang bisa aku bantu?")
...
prompt = st.chat_input("Chat with AI man Code here...")   
...
st.sidebar.title("Tentang Pemdes AI man Code")
# st.sidebar.markdown(
#     """
